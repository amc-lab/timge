    ...
    useEffect(() => {
        ...
        group.selectAll("path.bar")
            ...
            .attr("d", (d) => {
                ...
                const startAngle = segment.startAngle + (d.start / segment.length) * (segment.endAngle - segment.startAngle);
                const endAngle = segment.startAngle + (d.end / segment.length) * (segment.endAngle - segment.startAngle);
