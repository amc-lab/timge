...
export default function AssemblyForm({ onUpdate }: { 
  ...
  const [tickTextPadding, setTickTextPadding] = useState(3);
    ...
    const onFormUpdate = () => {
        ...
        onUpdate(segmentPadding, axisLabelFontSize, showAxis, segmentInnerRadius, segmentOuterRadius, segmentGridPadding, showAxisLabels, canvasWidth, canvasHeight, tickLength, tickTextPadding);
    };
    ...
    <div>
        <form>
            ...
            <label>
                ...
                <input type="range" min="0" max="10" step="1" value={axisLabelFontSize} onChange={(e) => setAxisLabelFontSize(parseFloat(e.target.value))} />
            <br />
            <label>
                Show Axis
